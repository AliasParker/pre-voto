...
<div class="border border-line rounded-lg p-4">
  <h3 class="font-semibold mb-3">{t(locale, "results.shareTitle")}</h3>
  <div class="flex flex-wrap gap-2">
    ...
    <button
      onclick={copyLink}
      class="flex items-center gap-2 px-3 py-2 bg-paper-warm text-ink-soft rounded-lg text-sm hover:bg-line transition-colors"
